...
# =============================================================================
# Provisions Azure infrastructure using Bicep templates
# Creates: Resource Group, VNet, Bastion, Proxy, App Server, PostgreSQL
# =============================================================================
...
echo ""
echo "Next steps:"
echo "  1. Wait for PostgreSQL:    ./scripts/wait-for-postgresql.sh"
echo "  2. Wait for cloud-init:    ./scripts/wait-for-vms-cloud-init.sh"
echo "  3. Deploy application:     ./deploy/deploy.sh"
echo "  4. Verify health:          ./scripts/wait-for-flask-app.sh"
echo ""
